...
class _DialerHomeScreenState extends State<DialerHomeScreen>
  ...
  void initState() {
    ...
    // -------------------------------------------------------------------
    // This also handles the case when Flutter engine starts after an incoming call
    // Android may have stored the number while Flutter was not ready
    // The service will fetch the stored number and show IncomingCallScreen
    // -------------------------------------------------------------------
